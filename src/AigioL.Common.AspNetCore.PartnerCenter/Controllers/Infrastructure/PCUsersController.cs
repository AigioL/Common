...
public static partial class PCUsersController
{
    ...
    static async Task<BMApiRsp> Post<TUser>(HttpContext context, AddBMUserModel model, Guid tenantId) where TUser : PCUser, new()
    {
    ...
    static async Task<BMApiRsp> Put<TUser>(HttpContext context, Guid id, EditBMUserModel model) where TUser : PCUser
    {
