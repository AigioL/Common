...
public sealed class SendSmsRequest : AbstractModel
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("PhoneNumberSet")]
    public required string[] PhoneNumberSet { get; set; }

    /// <summary>
    /// 短信 SdkAppId，在 [短信控制台](https://console.cloud.tencent.com/smsv2/app-manage)  添加应用后生成的实际 SdkAppId，示例如1400006666。
    /// </summary>
    [JsonPropertyName("SmsSdkAppId")]
    public required string SmsSdkAppId { get; set; }
    ...
    {
        SetParamArraySimple(map, prefix + "PhoneNumberSet.", PhoneNumberSet);
        SetParamSimple(map, prefix + "SmsSdkAppId", SmsSdkAppId);
        SetParamSimple(map, prefix + "TemplateId", TemplateId);
        SetParamSimple(map, prefix + "SignName", SignName);
        SetParamArraySimple(map, prefix + "TemplateParamSet.", TemplateParamSet);
        SetParamSimple(map, prefix + "ExtendCode", ExtendCode);
        SetParamSimple(map, prefix + "SessionContext", SessionContext);
        SetParamSimple(map, prefix + "SenderId", SenderId);
    }
}