...
static partial class BMMinimalApis
{
    ...
    /// <returns></returns>
    public static string DecryptAC(RSA rsa, ReadOnlySpan<char> text)
    {
    ...
    /// <returns></returns>
    public static string DecryptBase64AC(RSA rsa, ReadOnlySpan<char> text)
    {
        ReadOnlySpan<char> separator = [' ', '\r', '\n'];
        var split = text.Split(separator);
    ...
    public static void MapGetRSADemoHtml(this IEndpointRouteBuilder b, [StringSyntax("Route")] string pattern = "rsa")
    {
