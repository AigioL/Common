    ...
    IPasswordHash
{
    ...
    /// 由此用户审核的租户列表
    /// </summary>
    public virtual List<ACTenant>? AuditorTenants { get; set; }

    ///// <inheritdoc cref="BMUserOrganization"/>
    //public List<BMUserOrganization>? Organizations { get; set; }

    public sealed class EntityTypeConfiguration : IEntityTypeConfiguration<ACUser>
    {
        /// <inheritdoc/>
...
partial class ACUser : ICreationBaseEntity<Guid>
{
    /// <inheritdoc/>
    [Comment("创建时间")]
...
partial class ACUser : IOperatorBaseEntity<Guid>
{
    /// <inheritdoc/>
    [Comment("更新时间")]
...
partial class ACUser : ITenantBaseEntity<Guid>
{
    /// <inheritdoc/>
    [Comment("是否软删除")]
