    ...
    IRowVersion
{
    ...
    /// </summary>
    [Comment("审核状态")]
    public ACTenantAuditStatus AuditStatus { get; set; }
    ...
    public sealed class EntityTypeConfiguration : EntityTypeConfiguration<ACTenant>
    {
        /// <inheritdoc/>
        public sealed override void Configure(EntityTypeBuilder<ACTenant> builder)
        {
