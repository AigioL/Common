...
/// </summary>
public sealed class SteamUtils007 : NativeWrapper<ISteamUtils009>
{
    ...
    {
        var __retVal = ((delegate* unmanaged[Thiscall]<nint, sbyte>)Functions.IsSteamChinaLauncher)(ObjectAddress);
        return __retVal != 0;
    }
    ...
    {
        var __retVal = ((delegate* unmanaged[Thiscall]<nint, sbyte>)Functions.IsSteamRunningInVR)(ObjectAddress);
        return __retVal != 0;
    }
    ...
    {
        var __retVal = ((delegate* unmanaged[Thiscall]<nint, uint>)Functions.GetServerRealTime)(ObjectAddress);
        return __retVal;
    }
    ...
    {
        var __retVal = ((delegate* unmanaged[Thiscall]<nint, uint>)Functions.GetSecondsSinceAppActive)(ObjectAddress);
        return __retVal;
    }
    ...
    {
        var __retVal = ((delegate* unmanaged[Thiscall]<nint, sbyte>)Functions.IsSteamInBigPictureMode)(ObjectAddress);
        return __retVal != 0;
    }
