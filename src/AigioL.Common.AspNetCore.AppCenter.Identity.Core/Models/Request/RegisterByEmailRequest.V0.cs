...
/// <summary>
/// 账号注册（通过邮箱）接口请求模型（版本 0）
/// </summary>
[global::MemoryPack.MemoryPackable(global::MemoryPack.GenerateType.Object, global::MemoryPack.SerializeLayout.Explicit)]
[Obsolete("use RegisterByEmailRequestV2")]
public sealed partial record class RegisterByEmailRequestV0 : IDeviceId
{
    /// <summary>
    /// 邮箱地址
    /// </summary>
...
#if DEBUG
[Obsolete("use RegisterByEmailRequestV2", true)]
