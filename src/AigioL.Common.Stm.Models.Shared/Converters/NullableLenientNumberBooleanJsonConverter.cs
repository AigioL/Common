...
/// <summary>
/// 宽容的数字布尔值转换器，支持将数字 0/1 或字符串 "true"/"false" 转换为可空布尔值
/// </summary>
public sealed partial class NullableLenientNumberBooleanJsonConverter : JsonConverter<bool?>
{
    /// <inheritdoc/>
            ...
            case JsonTokenType.String:
                {
                    ...
                    else
                    {
                        ...
                        else if (string.Equals("NULL", str, StringComparison.InvariantCultureIgnoreCase))
                        {
                            return null;
                        }
                        else
