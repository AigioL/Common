...
public abstract partial class NullableUnixTimeToDateTimeOffsetConverter<TDateTime> : JsonConverter<TDateTime?>
            ...
            case JsonTokenType.String:
                {
                    ...
                    {
                        if (unixTimestamp == 0) // 0 表示 null，无效值
                        {
                            return null;
                        }
...
/// </summary>
public partial class NullableUnixTimeSecondsStringToDateTimeOffsetConverter : NullableUnixTimeToDateTimeOffsetConverter<DateTimeOffset>
{
    /// <inheritdoc/>
...
/// </summary>
public sealed partial class NullableUnixTimeSecondsToDateTimeOffsetConverter : UnixTimeSecondsStringToDateTimeOffsetConverter
{
    /// <inheritdoc/>
    protected override bool UseStringWrite => false;
}