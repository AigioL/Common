...
namespace AigioL.Common.Repositories.Abstractions;

/// <inheritdoc cref="IRepository"/>
public interface IRepository<[DynamicallyAccessedMembers(IEntity.DAMT)] TEntity, [DynamicallyAccessedMembers(IEntity.DAMT)] TPrimaryKey> : IRepository<TEntity>, IGetPrimaryKey<TEntity, TPrimaryKey>
    ...
    where TPrimaryKey : IEquatable<TPrimaryKey>
{
    ...
    Task<TEditViewModel?> GetEditByIdAsync<TEditViewModel>(TPrimaryKey primaryKey, CancellationToken cancellationToken = default) where TEditViewModel : notnull, IReadOnlyId<TPrimaryKey>
    {
